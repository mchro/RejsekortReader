...
/**
 * A list fragment representing a list of Blocks. This fragment also supports
...
public class BlockListFragment extends ListFragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (mRKFCard != null) {
			...
			mItems = new ArrayList<String>(mRKFCard.allBlocks.keySet()); 
			...
			Toast t = Toast.makeText(getActivity(), "No card read", Toast.LENGTH_LONG);
			t.show();
		}
	}
